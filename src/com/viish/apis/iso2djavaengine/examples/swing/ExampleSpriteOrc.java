...
public class ExampleSpriteOrc extends Sprite
{
	public ExampleSpriteOrc(Class<?> classe, String path) throws IOException
	{
		...
		orcStandNW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit()
				.getImage(classe.getResource(path + "NW/stand_0.png"))));
		addAnimation(AnimationType.IDLE, orcStandNW, Orientation.NORTH_WEST);

		List<ImageWrapper> orcStandNE = new ArrayList<ImageWrapper>();
		orcStandNE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit()
				.getImage(classe.getResource(path + "NE/stand_0.png"))));
		addAnimation(AnimationType.IDLE, orcStandNE, Orientation.NORTH_EAST);

		List<ImageWrapper> orcWalkNW = new ArrayList<ImageWrapper>();
		orcWalkNW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NW/walk_1.png"))));
		orcWalkNW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NW/stand_0.png"))));
		orcWalkNW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NW/walk_2.png"))));
		addAnimation(AnimationType.WALK, orcWalkNW, Orientation.NORTH_WEST);

		List<ImageWrapper> orcWalkNE = new ArrayList<ImageWrapper>();
		orcWalkNE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NE/walk_1.png"))));
		orcWalkNE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NE/stand_0.png"))));
		orcWalkNE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "NE/walk_2.png"))));
		addAnimation(AnimationType.WALK, orcWalkNE, Orientation.NORTH_EAST);

		List<ImageWrapper> orcStandSE = new ArrayList<ImageWrapper>();
		orcStandSE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit()
				.getImage(classe.getResource(path + "SE/stand_0.png"))));
		addAnimation(AnimationType.IDLE, orcStandSE, Orientation.SOUTH_EAST);

		List<ImageWrapper> orcWalkSE = new ArrayList<ImageWrapper>();
		orcWalkSE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SE/walk_1.png"))));
		orcWalkSE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SE/stand_0.png"))));
		orcWalkSE.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SE/walk_2.png"))));
		addAnimation(AnimationType.WALK, orcWalkSE, Orientation.SOUTH_EAST);

		List<ImageWrapper> orcStandSW = new ArrayList<ImageWrapper>();
		orcStandSW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit()
				.getImage(classe.getResource(path + "SW/stand_0.png"))));
		addAnimation(AnimationType.IDLE, orcStandSW, Orientation.SOUTH_WEST);

		List<ImageWrapper> orcWalkSW = new ArrayList<ImageWrapper>();
		orcWalkSW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SW/walk_1.png"))));
		orcWalkSW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SW/stand_0.png"))));
		orcWalkSW.add(new AWTImageWrapper(Toolkit.getDefaultToolkit().getImage(
				classe.getResource(path + "SW/walk_2.png"))));
