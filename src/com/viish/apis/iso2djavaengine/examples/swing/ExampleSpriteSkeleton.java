...
{
	public ExampleSpriteSkeleton(Class<?> classe, String path)
			throws IOException
	{
		...
		ImageWrapper all = new AWTImageWrapper(Toolkit.getDefaultToolkit()
				.getImage(classe.getResource(path + "Skeleton.png")));

		List<ImageWrapper> standNW = new ArrayList<ImageWrapper>();
		ImageWrapper stand_0_NW = all.getSubImage(1614, 330, 103, 112).resize(
				50, 57);
		...
		ImageWrapper walk_0_NW = all.getSubImage(79, 330, 103, 112).resize(50,
				57);
		walkNW.add(walk_0_NW);
		ImageWrapper walk_1_NW = all.getSubImage(331, 323, 103, 112).resize(50,
				57);
		walkNW.add(walk_1_NW);
		ImageWrapper walk_2_NW = all.getSubImage(587, 325, 103, 112).resize(50,
				57);
		walkNW.add(walk_2_NW);
		ImageWrapper walk_3_NW = all.getSubImage(842, 323, 103, 112).resize(50,
				57);
		...
		ImageWrapper stand_0_NE = all.getSubImage(1614, 838, 103, 112).resize(
				50, 57);
		...
		ImageWrapper walk_0_NE = all.getSubImage(81, 837, 103, 112).resize(50,
				57);
		walkNE.add(walk_0_NE);
		ImageWrapper walk_1_NE = all.getSubImage(340, 839, 103, 112).resize(50,
				57);
		walkNE.add(walk_1_NE);
		ImageWrapper walk_2_NE = all.getSubImage(605, 844, 103, 112).resize(50,
				57);
		walkNE.add(walk_2_NE);
		ImageWrapper walk_3_NE = all.getSubImage(858, 835, 103, 112).resize(50,
				57);
		...
		ImageWrapper stand_0_SE = all.getSubImage(1614, 1355, 103, 112).resize(
				50, 57);
		...
		ImageWrapper walk_0_SE = all.getSubImage(80, 1355, 103, 112).resize(50,
				57);
		walkSE.add(walk_0_SE);
		ImageWrapper walk_1_SE = all.getSubImage(334, 1349, 103, 112).resize(
				50, 57);
		walkSE.add(walk_1_SE);
		ImageWrapper walk_2_SE = all.getSubImage(590, 1351, 103, 112).resize(
				50, 57);
		walkSE.add(walk_2_SE);
		ImageWrapper walk_3_SE = all.getSubImage(847, 1348, 103, 112).resize(
				50, 57);
		...
		ImageWrapper stand_0_SW = all.getSubImage(1614, 1860, 103, 112).resize(
				50, 57);
		...
		ImageWrapper walk_0_SW = all.getSubImage(74, 1862, 103, 112).resize(50,
				57);
		walkSW.add(walk_0_SW);
		ImageWrapper walk_1_SW = all.getSubImage(325, 1857, 103, 112).resize(
				50, 57);
		walkSW.add(walk_1_SW);
		ImageWrapper walk_2_SW = all.getSubImage(578, 1869, 103, 112).resize(
				50, 57);
		walkSW.add(walk_2_SW);
		ImageWrapper walk_3_SW = all.getSubImage(834, 1867, 103, 112).resize(
				50, 57);
